...
| Gerenciador de receitas (novo projeto, sem dependências externas: despensa com estoque e alertas, mercado com 110 ingredientes em 14 tipos, 402 receitas — 72 delas de 22 países — com gramagem, macros e modo de preparo em checklist) | `gerenciador-de-receitas/` | https://andreybueno-git.github.io/front-end/gerenciador-de-receitas/ |
